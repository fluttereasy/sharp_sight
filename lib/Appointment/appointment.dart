...
class ApointmentBar extends StatefulWidget {
  const ApointmentBar({Key? key}) : super(key: key);

  @override
  State<ApointmentBar> createState() => _ApointmentBarState();
}

class _ApointmentBarState extends State<ApointmentBar> {
  final List<Map<String, dynamic>> _allUsers = [
    {
      "image":
          "https://th.bing.com/th/id/OIP.EYHt8f5tqkTU5l6szP5XbQHaE8?pid=ImgDet&rs=1",
      "id": 1,
      "name": "Dr. Manu Kumar",
      "des": "Co-founder & CEO @ ",
    },
